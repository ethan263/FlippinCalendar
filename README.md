...
This project is provided for learning and development.

### You CAN

- ✅ Use this project for **personal learning and education**
- ✅ Fork it and **modify** it for your own purposes
- ✅ Use it as a **portfolio project**

### You CANNOT

- ❌ Use it for **commercial purposes** without a separate license
- ❌ Sell it or include it in a paid product without permission

Third-party names and logos (Clerk, Convex, ElevenLabs, Vercel, Next.js, React, Tailwind CSS, TypeScript, etc.) are trademarks of their respective owners.
